...
alter table school owner to lms_dev;
...
alter table permission owner to lms_dev;
...
alter table user_account owner to lms_dev;
...
alter table tenant owner to lms_dev;
...
alter table role owner to lms_dev;
...
alter table role_permission owner to lms_dev;
...
alter table school_tenant_mapping owner to lms_dev;
...
alter table user_tenant_role_assignment owner to lms_dev;
...
alter table curriculum_node owner to lms_dev;
...
alter table content_item owner to lms_dev;
...
alter table user_favorite_content owner to lms_dev;
...
alter table content_comment owner to lms_dev;
...
alter table content_permission owner to lms_dev;
...
alter table audit_log owner to lms_dev;
...
alter table schema_migrations owner to lms_dev;
...
alter table catalog_item owner to lms_dev;

create index idx_catalog_item_type on catalog_item (type) where (is_deleted = false);
...
alter table user_session owner to lms_dev;

create index idx_user_session_user_id on user_session (user_id) where (status = 'ACTIVE'::session_status);
create index idx_user_session_tenant_id on user_session (user_id, tenant_id) where (status = 'ACTIVE'::session_status);
create index idx_user_session_school_id on user_session (user_id, school_id) where (status = 'ACTIVE'::session_status);
create index idx_user_session_expires_at on user_session (user_id, expires_at) where (status = 'ACTIVE'::session_status);
